                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (deletedCategories.ResultStatusType ===0) {
                                $.each(deletedCategories.Categories.$values,
                                    function (index, category) {
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            category.Note,
                                            convertToDateString(category.CreatedDate),
                                            category.CreatedByName,
                                            convertToDateString(category.UpdateDate),
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (undoDeletedCategoryResult.ResultStatusType===0) {
                                Swal.fire(
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${categoryName} adlı kategori kalıcı olarak silinicektir!`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
