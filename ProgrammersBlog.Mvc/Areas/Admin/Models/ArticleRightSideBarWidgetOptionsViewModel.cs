...
{
    //Modelim ile hemen hemen aynı aradaki fark bizlerin bir model'a kategori listesi taşıyor olması
    //kullancı categoryId'yi modelden seçtikten sonra kategori listesi sunacağız.
